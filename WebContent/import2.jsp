  ...
  <body class="composite">
    ...
    <div id="bodyColumn">
      ...
      <form action="<%=path %>/import3.jsp" method="post">
       ...
       <label hidden="true">数据库类型：</label><input type="text" id="DBType" name="DBType" value="<%=DBType %>" hidden="true"/>
       <label hidden="true">主机ip:</label><input type="text" id="hostIp" name="hostIp" value="<%=hostIp %>" hidden="true"/>
       <label>端口号：</label><input type="text" id="port" name="port" value="<%=port %>"/></br></br>
		<label>用户名：</label><input type="text" id="DBUser" name="DBUser" value="<%=DBUser %>"/></br></br>
		<label>密码：</label><input type="password" id="DBPassword" name="DBPassword" value="<%=DBPassword %>"/></br></br>
		<label>数据库名：</label><input type="text" id="schema" name="schema" value="<%=schema %>"/></br></br>
		<label>表名：</label><input type="text" id="tableName" name="tableName" value="<%=tableName %>"/></br></br>
		<label>where条件</label><input type="text" id="where" name="where" value="<%=where %>"/></br></br>
