...
将数据在大数据平台间迁移。当需要将数据从“一个”Hadoop集群迁移到“另一个”Hadoop集群时可以新建此作业。</br>
新建步骤如下</br>
一、	选择数据导出源的Hadoop平台的列分隔符、行分隔符以及目标位置。</br>
<center><img src="<%=path %>/images/help/HDFSTransfer1.png" alt="" /></center></br></br></br></br></br></br>
