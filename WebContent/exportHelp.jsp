...
将数据从大数据平台导出。当需要将数据从Hadoop平台导出到某个特定的关系型数据库时可以新建此作业。</br>
新建步骤如下</br>
一、	选择数据导出源的Hadoop平台的列分隔符、行分隔符以及目标位置。</br>
<center><img src="<%=path %>/images/help/export1.png" alt="" /></center></br></br></br></br></br></br>
二、	选择导出目的关系数据库的参数。包括数据库类型（MySql、Oracle等）、主机ip地址、端口号、用户名、密码、数据库名、表名。</br>
<center><img src="<%=path %>/images/help/export2.png" alt="" /></center></br></br></br></br></br></br>
三、	选择是否覆盖数据。</br>
<center><img src="<%=path %>/images/help/export3.png" alt="" /></center></br></br></br></br></br></br>
四、	选择直接执行作业，或者将作业参数保存到系统中，以便下次直接执行此作业。</br>
<center><img src="<%=path %>/images/help/export4.png" alt="" /></center></br></br></br></br></br></br>
</div>
      </div>
    </div>
    <div class="clear">
