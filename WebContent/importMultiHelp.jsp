...
<h2>多源导入教程</h2>
将多个数据源的数据导入到大数据平台。当需要将数据从“多个”特定的关系型数据库导入到Hadoop平台时可以新建此作业。</li></br>
新建步骤如下</br>
一、	选择待导入的关系数据库的参数。包括数据库类型（MySql、Oracle等）、主机ip地址、端口号、用户名、密码、数据库名、表名、筛选条件，这些关系数据库可以选择“多个”。</br>
<center><img src="<%=path %>/images/help/importMulti1.png" alt="" /></center></br></br></br></br></br></br>
二、	选择数据导入到Hadoop平台的列分隔符、行分隔符以及目标位置。</br>
<center><img src="<%=path %>/images/help/importMulti2.png" alt="" /></center></br></br></br></br></br></br>
三、	选择直接执行作业，或者将作业参数保存到系统中，以便下次直接执行此作业。</br>
<center><img src="<%=path %>/images/help/importMulti3.png" alt="" /></center></br></br></br></br></br></br>
</br></br></br></br>
</div>
      </div>
    </div>
