...
<body class="composite">
	<div id="banner">
		<a href="http://hadoop.apache.org/" id="bannerLeft"> <img
	...
	<div id="breadcrumbs">
		...
		<div class="xright">
			<a href="http://wiki.apache.org/hadoop" class="externalLink">Wiki</a>
			| <a href="https://svn.apache.org/repos/asf/hadoop/"
	...
	<div id="bodyColumn">
		<div id="contentBox">
			<center>
				<form action="<%=path%>/importMulti3.jsp" method="post">
	...
	<div id="footer">
		<div class="xright">
			&#169; 2014 Apache Software Foundation - <a
